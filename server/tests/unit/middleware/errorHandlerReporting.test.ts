...
async function loadErrorHandler() {
  return import('../../../src/middleware/errorHandler.js');
}
...
describe('expected client errors are not incidents', () => {
  it.each([
    ['authentication', () => import('../../../src/middleware/errorHandler.js').then(m => new m.AuthenticationError())],
    ['not found', () => import('../../../src/middleware/errorHandler.js').then(m => new m.NotFoundError('Project'))],
    ['conflict', () => import('../../../src/middleware/errorHandler.js').then(m => new m.ConflictError('stale revision'))],
    ['validation', () => import('../../../src/middleware/errorHandler.js').then(m => new m.ValidationError(['name required']))],
