 ...
 * Cell Component
 * 
 * Individual cell in the data grid with editing, selection, and autofill support.
 */
...
export const Cell = memo(function Cell({
  ...
  const formattedPreviewValue = useMemo(() => {
    ...
    if (column.type === 'boolean' || typeof autofillPreviewValue === 'boolean') {
      if (autofillPreviewValue === true || autofillPreviewValue === 'true' || autofillPreviewValue === 'True')
        return 'True';
      if (autofillPreviewValue === false || autofillPreviewValue === 'false' || autofillPreviewValue === 'False')
        return 'False';
    }
  ...
  return (
    <div
      ...
      style={{ width, minWidth: width, maxWidth: width, height: GRID.rowHeight }}
      ...
      {isEditing ? (
        <div className="absolute inset-0 flex items-center">
          <input
            ...
            onBlur={onBlur}
            className={clsx(
              'w-full h-full px-2 border-none outline-none text-sm bg-transparent',
        ...
        <>
          ...
          {isInAutofillRange && autofillPreviewValue !== undefined ? (
            ...
            <span
              className={clsx(
                'truncate w-full',
                (value === null || value === undefined || value === '') && 'text-text-tertiary italic'
              )}
            >
