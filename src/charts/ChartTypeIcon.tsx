...
export function ChartTypeIcon({ type, className, ...props }: ChartTypeIconProps) {
  const svgProps = { className, 'aria-hidden': true as const, ...props }

  switch (type) {
    case 'bar':
      return (
        <svg fill="currentColor" viewBox="0 0 24 24" {...svgProps}>
    ...
    case 'line':
      return (
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} {...svgProps}>
