...
import { Toast } from '@/suggestions/panel/Toast'
import { ImportButton } from '@/components/ImportButton'
import type { Suggestion } from '@/types'
import { formatNumber } from '@/lib/utils'
import { useNavigation } from '@/layout/navigation/NavigationContext'
import { useSuggestionNavigation } from '@/suggestions/panel/state/useSuggestionNavigation'
  ...
  return (
    <div className="h-full flex items-center justify-center">
      <div className="max-w-md px-4 text-center">
        <div className="w-16 h-16 mx-auto mb-5 rounded-2xl bg-accent-green/10 flex items-center justify-center">
