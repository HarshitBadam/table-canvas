...
export function CycleWarningToast({ warning, onClose }: CycleWarningToastProps) {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 animate-fade-in">
      <div
        className="flex items-start gap-3 px-4 py-3 bg-amber-50 dark:bg-amber-900/90 border border-amber-200 dark:border-amber-700 rounded-xl shadow-lg max-w-md"
        role="alert"
      >
