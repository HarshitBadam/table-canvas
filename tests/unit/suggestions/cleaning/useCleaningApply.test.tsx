...
import { useSuggestionsStore } from '@/suggestions/panel/state/suggestionsStore'
...
vi.mock('@/suggestions/commands/types', () => ({ showToast }))

import { useCleaningApply } from '@/suggestions/cleaning/useCleaningApply'
