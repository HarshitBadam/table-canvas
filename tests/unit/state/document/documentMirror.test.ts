...
import type { DocumentIdentity } from '@/state/document/documentIdentity'
...
interface Tab {
  db: typeof import('@/persistence/storage/local-db/db')
  mirror: typeof import('@/state/document/documentMirror')
  projectStore: typeof import('@/state/projectStore')
  runtimeStore: typeof import('@/state/tableRuntimeStore')
}
...
async function openTab(): Promise<Tab> {
  ...
  const [db, mirror, projectStore, runtimeStore] = await Promise.all([
    import('@/persistence/storage/local-db/db'),
    import('@/state/document/documentMirror'),
    import('@/state/projectStore'),
    import('@/state/tableRuntimeStore'),
  ])
