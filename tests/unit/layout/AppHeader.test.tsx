...
import type { ProjectExportState } from '@/layout/project-controls/useProjectExport'
...
vi.mock('@/layout/project-controls/ProjectSwitcher', () => ({ ProjectSwitcher: () => <span>Project</span> }))
